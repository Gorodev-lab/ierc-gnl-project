    ...
    def analyze_uncertainty_distribution(self, results: List[Dict]) -> Dict[str, Union[float, int, str, Dict]]:
        ...
        try:
            ...
            if analysis['mean_confidence'] < 0.7:
                ...
                analysis['recommendations'].append(
                    "⚠️  Nivel de confianza moderado (0.7-0.85). Validar datos críticos y considerar:"
    ...
    def generate_uncertainty_report(self, results: List[Dict], analysis: Dict) -> str:
        ...
        try:
            ...
            if high_uncertainty > analysis['total_simulations'] * 0.15:
                report_lines.append("⚠️  ALERTA: Alto nivel de incertidumbre detectado en múltiples celdas.")
                ...
                report_lines.append("⚠️  Nivel de confianza MODERADO. Validar datos antes de decisiones críticas.")
