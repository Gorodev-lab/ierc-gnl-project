...
<!--[if gt IE 8]><!--><html lang="en" class="no-js"><!--<![endif]-->
  <head>
    ...
    <link rel="stylesheet" href="/assets/application-1ea9e6896a0e9c4c0fec0d4b7a937c47698d7ae4f2708486be9e5398c1b5da2e.css" media="all" />
    <!--[if IE 7]>
...
<meta name="csrf-token" content="lrqMYkk5HRRhkJFmwo1ban_NFMpmOhTGLNXt5WIRzmKPMcisltyVyxgw60OHOqbDYEazyZWV264coRq1rEUhYg" />
  ...
  <form id="login" action="/login" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="wHsxm4WZMZWWuvsp9Ha52pyRITB2oTG3nFYRJ52iUfjejuKsb-2PgFZ3MUf8lcBEs1Ot1ArDLSFPK0RLIRuNWA" />
  <p>
  ...
  <p>
    <input type="hidden" name="client_id" id="client_id" value="pDPu0awH156XLrK6VV0Y0w" />
  </p>
  <p>
    <input type="hidden" name="redirect_uri" id="redirect_uri" value="https://oceandata.sci.gsfc.nasa.gov/getfile/urs/" />
  </p>
        <p><input type="hidden" name="response_type" id="response_type" value="code" /></p>
...
<aside class="govt-msg">
  ...
  <div class="warning-mobile-mini">
    ...
    <script src="/assets/application-ad54b9f642165bef26a676f9c7ecb57093ba1c2b0fb1922f2ae00de958274d44.js"></script>
...
<script id="f5_cspm">(function(){var f5_cspm={f5_p:'GOHCDGKEIMOPLBEMJBDKOMJJPBNNGLHNCHCDIMDAANJEMGCMDPMKAHGJNKAKGKCEBJNBAHMIAAPGDEDCNFLACIFAAAEEOHCCDCOJCIOIDFMPMPMJFLKPIEKLNLGDFIJK',setCharAt:function(str,index,chr){if(index>str.length-1)return str;return str.substr(0,index)+chr+str.substr(index+1);},get_byte:function(str,i){var s=(i/16)|0;i=(i&15);s=s*32;return((str.charCodeAt(i+16+s)-65)<<4)|(str.charCodeAt(i+s)-65);},set_byte:function(str,i,b){var s=(i/16)|0;i=(i&15);s=s*32;str=f5_cspm.setCharAt(str,(i+16+s),String.fromCharCode((b>>4)+65));str=f5_cspm.setCharAt(str,(i+s),String.fromCharCode((b&15)+65));return str;},set_latency:function(str,latency){latency=latency&0xffff;str=f5_cspm.set_byte(str,40,(latency>>8));str=f5_cspm.set_byte(str,41,(latency&0xff));str=f5_cspm.set_byte(str,35,2);return str;},wait_perf_data:function(){try{var wp=window.performance.timing;if(wp.loadEventEnd>0){var res=wp.loadEventEnd-wp.navigationStart;if(res<60001){var cookie_val=f5_cspm.set_latency(f5_cspm.f5_p,res);window.document.cookie='f5avr0386692093aaaaaaaaaaaaaaaa_cspm_='+encodeURIComponent(cookie_val)+';path=/;'+'';}
return;}}
catch(err){return;}
