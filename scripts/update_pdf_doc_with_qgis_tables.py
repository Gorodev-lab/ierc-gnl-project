...
----------------------------------
Genera el Documento Ejecutivo y Catálogo Cartográfico listo para PDF (DOCUMENTO_EJECUTIVO_ENTREGABLE1_PDF.html)
siguiendo estrictamente la guía de estilo institucional de Causa Natura Data:
- Fondo claro/blanco (#ffffff / #f8fafc) adecuado para lectura ejecutiva e impresión a PDF.
- Paleta institucional (Azul Marino #002B49, Azul Primario #006699, Gris Pizarra #334155).
- Tablas de metadatos extraídos estilo QGIS con contraste institucional.
- Mapas comparativos (OpenStreetMap estilo QGIS + Esri Satelital) con rutas corregidas.
- Cajas explicativas para revisores no técnicos y Glosario de Términos.
- 100% libre de emoticones.
"""
...
# ── Generar HTML Document con Guía de Estilo Institucional Causa Natura Data (Fondo Claro) ──
html_content = f"""<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Documento Ejecutivo y Catálogo Cartográfico (POA 2026) — Causa Natura Data</title>
    <style>
        /* GUÍA DE ESTILO INSTITUCIONAL CAUSA NATURA DATA */
        :root {{
            --navy-brand: #002B49;
            --blue-accent: #006699;
            --blue-light: #e0f2fe;
...
<div class="container">
    ...
    <!-- BANNER Y PORTADA INSTITUCIONAL CAUSA NATURA DATA -->
    <div class="header-banner">
        ...
        <p><strong>Organización:</strong> Causa Natura Center / Causa Natura Data (POA 2026-2028)</p>
    </div>
    ...
    <div class="header-meta">
        ...
        <p><strong>Fecha de Emisión del Entregable:</strong> 19 de Agosto de 2026</p>
...
print(f"Documento HTML imprimible estilo Causa Natura Data generado exitosamente en: {HTML_PDF_PATH}")
